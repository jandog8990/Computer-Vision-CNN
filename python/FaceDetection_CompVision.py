...
# ================================================
# Second Implementation: Nested CV (inner/outer)
# ================================================
...
#scores = nested_cv(X, y, FrameGroup, inner_cv, outer_cv, BoxClassifier, parameter_grid)
